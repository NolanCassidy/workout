...
async function createOrderAndSession(req, res) {
  ...
  stripe.checkout.sessions.create({
    ...
    success_url: 'https://limitless-citadel-96586.herokuapp.com/challenge/',
    cancel_url: 'https://limitless-citadel-96586.herokuapp.com/welcome/',
  }).then(session => {
...
const endpointSecret = 'whsec_xMQMFMJVBIRpBEfh593CC0l0BYTS0emx';
// Our app has to use express
